...
//Prep the scheme 
// added this part because kept on having ERROR taht scheme was not prepped, even though it was prepped...
process prepscheme{
    ...
    script:
    """
    chewBBACA.py PrepExternalSchema -i $inputscheme -o schemeFINAL --cpu $params.cpu
    """
} 
...
process analysis{
    ...
    chewBBACA.py AlleleCall -i $input4dir -g $outputdir/schemeFINAL/ -o Results --cpu $params.cpu
    """
