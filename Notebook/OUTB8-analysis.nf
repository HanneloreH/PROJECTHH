...
process analysis{
    ...
    chewBBACA.py AlleleCall -i $input4dir -g $inputscheme -o Results --cpu $params.cpu --fc --ptf $trainingfile
    """
    //fc : force continue if "do you wish to proceed" occurs
    // TEMP: removed --ptf $trainingfile because of compatibility errors (see problem v2.1.0<>2.4.5) -> remark is done in analysis anyhow
}
